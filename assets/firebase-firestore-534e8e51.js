import{_ as t,C as e,r as n,F as s,d as r,b as i,t as o,L as a,u,h as c,S as h,m as l,k as d,v as f,l as g}from"./firebase-core-8eeeb07d.js";var p,m,y="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof self?self:{};
/** @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function na(t,e,n){let s;return s=t?n&&(n.merge||n.mergeFields)?t.toFirestore(e,n):t.toFirestore(e):e,s
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ua(t){t=so(t,ao);const e=so(t.firestore,go);return function(t,e,n={}){const s=new B;return t.asyncQueue.enqueueAndForget(async()=>function(t,e,n,s,r){const i=new $i({next:a=>{i.Za(),e.enqueueAndForget(()=>ui(t,o));const u=a.docs.has(n);!u&&a.fromCache?r.reject(new q(U.UNAVAILABLE,"Failed to get document because the client is offline.")):u&&a.fromCache&&s&&"server"===s.source?r.reject(new q(U.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):r.resolve(a)},error:t=>r.reject(t)}),o=new gi(Ne(n.path),i,{includeMetadataChanges:!0,_a:!0});return ai(t,o)}(await Xi(t),t.asyncQueue,e,n,s)),s.promise}(mo(e),t._key).then(n=>ya(e,t,n))}class ca extends ea{constructor(t){super(),this.firestore=t}convertBytes(t){return new yo(t)}convertReference(t){const e=this.convertDocumentKey(t,this.firestore._databaseId);return new ao(this.firestore,null,e)}}function ha(t){t=so(t,oo);const e=so(t.firestore,go),n=mo(e),s=new ca(e);return $o(t._query),function(t,e,n={}){const s=new B;return t.asyncQueue.enqueueAndForget(async()=>function(t,e,n,s,r){const i=new $i({next:n=>{i.Za(),e.enqueueAndForget(()=>ui(t,o)),n.fromCache&&"server"===s.source?r.reject(new q(U.UNAVAILABLE,'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')):r.resolve(n)},error:t=>r.reject(t)}),o=new gi(n,i,{includeMetadataChanges:!0,_a:!0});return ai(t,o)}(await Xi(t),t.asyncQueue,e,n,s)),s.promise}(n,t._query).then(n=>new oa(e,s,t,n))}function la(t,e,n){t=so(t,ao);const s=so(t.firestore,go),r=na(t.converter,e,n);return ma(s,[No(ko(s),"setDoc",t._key,r,null!==t.converter,n).toMutation(t._key,vn.none())])}function da(t,e,n,...s){t=so(t,ao);const r=so(t.firestore,go),i=ko(r);let o;return o="string"==typeof(e=c(e))||e instanceof vo?function(t,e,n,s,r,i){const o=t.Qu(1,e,n),a=[Fo(e,s,n)],u=[r];if(i.length%2!=0)throw new q(U.INVALID_ARGUMENT,`Function ${e}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let c=0;c<i.length;c+=2)a.push(Fo(e,i[c])),u.push(i[c+1]);const h=[],l=Zt.empty();for(let f=a.length-1;f>=0;--f)if(!Bo(h,a[f])){const t=a[f];let e=u[f];e=c(e);const n=o.Nu(t);if(e instanceof Do)h.push(t);else{const s=Lo(e,n);null!=s&&(h.push(t),l.set(t,s))}}const d=new St(h);return new Io(l,d,o.fieldTransforms)}(i,"updateDoc",t._key,e,n,s):function(t,e,n,s){const r=t.Qu(1,e,n);Po("Data must be an object, but it was:",r,s);const i=[],o=Zt.empty();vt(s,(t,s)=>{const a=Uo(e,t,n);s=c(s);const u=r.Nu(a);if(s instanceof Do)i.push(a);else{const t=Lo(s,u);null!=t&&(i.push(a),o.set(a,t))}});const a=new St(i);return new Io(o,a,r.fieldTransforms)}(i,"updateDoc",t._key,e),ma(r,[o.toMutation(t._key,vn.exists(!0))])}function fa(t){return ma(so(t.firestore,go),[new Rn(t._key,vn.none())])}function ga(t,e){const n=so(t.firestore,go),s=ho(t),r=na(t.converter,e);return ma(n,[No(ko(t.firestore),"addDoc",s._key,r,null!==t.converter,{}).toMutation(s._key,vn.exists(!1))]).then(()=>s)}function pa(t,...e){var n,s,r;t=c(t);let i={includeMetadataChanges:!1,source:"default"},o=0;"object"!=typeof e[o]||fo(e[o])||(i=e[o],o++);const a={includeMetadataChanges:i.includeMetadataChanges,source:i.source};if(fo(e[o])){const t=e[o];e[o]=null===(n=t.next)||void 0===n?void 0:n.bind(t),e[o+1]=null===(s=t.error)||void 0===s?void 0:s.bind(t),e[o+2]=null===(r=t.complete)||void 0===r?void 0:r.bind(t)}let u,h,l;if(t instanceof ao)h=so(t.firestore,go),l=Ne(t._key.path),u={next:n=>{e[o]&&e[o](ya(h,t,n))},error:e[o+1],complete:e[o+2]};else{const n=so(t,oo);h=so(n.firestore,go),l=n._query;const s=new ca(h);u={next:t=>{e[o]&&e[o](new oa(h,s,n,t))},error:e[o+1],complete:e[o+2]},$o(t._query)}return function(t,e,n,s){const r=new $i(s),i=new gi(e,r,n);return t.asyncQueue.enqueueAndForget(async()=>ai(await Xi(t),i)),()=>{r.Za(),t.asyncQueue.enqueueAndForget(async()=>ui(await Xi(t),i))}}(mo(h),l,a,u)}function ma(t,e){return function(t,e){const n=new B;return t.asyncQueue.enqueueAndForget(async()=>Ci(await function(t){return Wi(t).then(t=>t.syncEngine)}(t),e,n)),n.promise}(mo(t),e)}function ya(t,e,n){const s=n.docs.get(e._key),r=new ca(t);return new ra(t,r,e._key,s,new sa(n.hasPendingWrites,n.fromCache),e.converter)}function va(){return new Ro("serverTimestamp")}function wa(...t){return new xo("arrayUnion",t)}!function(s,r=!0){N=h,t(new e("firestore",(t,{instanceIdentifier:e,options:n})=>{const s=t.getProvider("app").getImmediate(),i=new go(new $(t.getProvider("auth-internal")),new W(t.getProvider("app-check-internal")),function(t,e){if(!Object.prototype.hasOwnProperty.apply(t.options,["projectId"]))throw new q(U.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Pt(t.options.projectId,e)}(s,e),s);return n=Object.assign({useFetchStreams:r},n),i._setSettings(n),i},"PUBLIC").setMultipleInstances(!0)),n(A,"4.7.3",s),n(A,"4.7.3","esm2017")}();export{ua as a,ga as b,co as c,ho as d,ha as e,wa as f,po as g,fa as h,va as i,pa as o,Ho as q,la as s,da as u,Xo as w};
